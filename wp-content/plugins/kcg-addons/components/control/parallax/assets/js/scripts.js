!(function (e, t) {
    ...
    var i = function (a) {
        ...
        (i.init = function () {
            return !(e(window).width() <= 320) && (i.setParallaxMulti(n), i.moveBg(n), !1);
        }),
                ...
                void 0 !== e.parallax_transform &&
                    ...
                    a
                        ...
                        .magician({
                            ...
                            duration: parseInt(e.smoothness), animation: {
            ...
            (i.pushElement = function (e) {
                ...
                0 === a.find(".elementor-repeater-item-" + e._id).length &&
                    "" != e.image.url &&
                    a.prepend(
                        `\n <div data-wow-delay="${wowDelay}ms" class="${cl} kcg-section-parallax-type-${e.parallax_style}" >\n <img class="kcg-parallax-graphic ${i}" src="${e.image.url}"/>\n </div>\n                    `
                    );
            }, i.getWOW = function (e) {
                ...
                'yes' == e._mousemove_scroll_enable && void 0 !== e._mousemove_parallax_transform && void 0 !== e._mousemove_parallax_transform_value && a.find(".elementor-repeater-item-" + e._id).magician({
                    type: "scroll",
